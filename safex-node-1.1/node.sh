...
script='community version: 2023.01.29..1'

# Hashtags(#) will be the start of a comment line, not code. 

# 1A. The Path to save data to. Default is:  /home/safex
dir='/home/safex'

# 1B. Clear logs
trunc="truncate -s 0 /var/**/*log* /var/**/*btmp* /var/**/*messages* /home/**/*log*"
echo
echo "Clearing Log files to save space"
$trunc
